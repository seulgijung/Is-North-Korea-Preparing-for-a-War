var config = {
    ...
    outroParagraphs: [
        ...
        "Since Mr. Yoon took office in 2022, diplomatic policy on the DPRK has grown extremely belligerent, aligning with the US’s “no-tolerance” policy that emphasizes  sanctions and isolation. Last October, Defense Minister Shin Won-sik made headlines announcing a new offensive military posture if the North provoves “PISU: Punish Immediately, Strongly, and Until the end (즉각, 강력히, 끝까지 응징)",
        "For many Koreans like Kang Sung-ae, whose husband died in the bombardment of Yeonpyeong Island, all the posturing obscures tragedy.",
        'When my husband died, I wondered if our military should have responded more strongly,” shesaid in an interview 2 years after the incident.. “But politicians seem to be all similar. It seems like they only listen to us during election season and that’s it once they get elected."',
        'Mr. Kim was working on the construction of a new residence for the Yeonpyeong Island Marine Corps unit on the day when artillery shells rained down.Ms. Kang knows very well her husband’s death will be forgotten from minds of people as time passes. "It is fortunate that stability has been restored to Yeonpyeong Island, but those of us who suddenly lost our loved one are still living in tears.”',
    ]
};
